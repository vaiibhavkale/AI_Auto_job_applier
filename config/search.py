...
search_terms = ["Software Engineer", "Software Developer", "Java Developer", "Java Spring boot Developer", "Java Spring boot Microservices Developer", "Full Stack Developer", "Web Developer", "Nodejs Developer"]
